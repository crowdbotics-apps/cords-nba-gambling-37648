...
## Project Structure
    ...
    ├── cords_nba_gambling_37648  # Django project configurations
...
1. Clone this repo and `cd cords_nba_gambling_37648`
...
2. Clone this repo and `cd cords_nba_gambling_37648`
